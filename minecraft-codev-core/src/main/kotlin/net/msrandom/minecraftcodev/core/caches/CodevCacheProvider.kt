...
fun CodevCacheProvider(gradle: Gradle) = object : CodevCacheProvider {
    private val root = (gradle as GradleInternal).serviceOf<GlobalScopedCache>()
    private val cache = ConcurrentHashMap<String, CodevCacheManager>()

    override fun manager(name: String) = cache.computeIfAbsent(name) {
