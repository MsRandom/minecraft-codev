...
class MixinDependencyMetadataWrapper(override val delegate: DependencyMetadata, override val relatedConfiguration: String) :
    MixinDependencyMetadata,
    DependencyMetadata by delegate

class SkipMixinsDependencyMetadataWrapper(override val delegate: DependencyMetadata) :
...
class DslOriginSkipMixinsDependencyMetadata(
    ...
    DslOriginDependencyMetadata,
    SkipMixinDependencyMetadata {
    override fun withTarget(target: ComponentSelector) = DslOriginSkipMixinsDependencyMetadata(delegate.withTarget(target), source)
