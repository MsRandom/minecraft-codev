...
object JarIntersection {
    ...
    private fun classIntersection(
        ...
        val nodeA = cacheA.computeIfAbsent(a, ::readNode)
        val nodeB = cacheB.computeIfAbsent(b, ::readNode)
        ...
        while (true) {
            ...
            if (existsA) {
                superNameA = cacheA.computeIfAbsent(superPathA, ::readNode).superName
            ...
            if (existsB) {
                superNameB = cacheB.computeIfAbsent(superPathB, ::readNode).superName
            }
