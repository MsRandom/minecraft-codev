...
data class AccessWidenedArtifactIdentifier(
    val id: ComponentArtifactIdentifier,
    private val accessWidenersHash: HashCode,
    private val originalHash: HashCode,
) {
    object ArtifactSerializer : Serializer<AccessWidenedArtifactIdentifier> {
        ...
        override fun write(
            encoder: Encoder,
            value: AccessWidenedArtifactIdentifier,
        ) {
